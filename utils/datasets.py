...
def prepare_pdb_valtest(scn_dir, data_path):
    """ prepare pdb validation and test dataset """
...
def rdmol_cluster_to_data(mol:Mol, smiles=None):
    """ Convert a RDKit molecule to a cluster data object."""

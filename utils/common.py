"""
Common set of utilities to manipulate, augment or track the training process
"""
...
class ExponentialLR_with_minLr(torch.optim.lr_scheduler.ExponentialLR):
    'Class of functions to get the Current and least LR for a model'
...
def repeat_data(data: Data, num_repeat) -> Batch:
    'Augment the data by repeating it'
...
def get_optimizer(cfg, model):
    'Setup the optimiser - currently only Adam'
    if cfg.type == 'adam':
